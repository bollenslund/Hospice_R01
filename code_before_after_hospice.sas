data trunc_table5;
set table5 (keep = bene_id start1 end1 ed_visit_ind discharge1 disenr IP_start1-IP_start39 IP_end1-IP_end39 IP_icued1-IP_icued39 admit_pre12m hosp_adm_ind hosp_adm_days hosp_adm_cnt ip_ed_visit_ind ip_ed_visit_cnt icu_stay_ind
...
%do i = 1 %to 39;
	...
	if ed_visit_ind = 1 and ip_start&i~=. then do;
		if ip_icued&i = 1 or ip_icued&i = 3 then do;
